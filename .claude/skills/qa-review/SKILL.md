...
## Test quality rules
- Describe **behaviour**, not implementation: `it('accepts ae as ae equivalent')` not `it('calls normalise()')`
- Cover: empty input, ae/oe/aa chars, case + whitespace, error paths (Supabase failure, empty array)
